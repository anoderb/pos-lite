...
import { useDataCollector } from './_hooks/useDataCollector';
...
export default function AdminDataCollectorPage() {
  const {
    ...
    classPage, setClassPage, classesPerPage,
    unmappedPage, setUnmappedPage, unmappedPerPage,
    galleryPage, setGalleryPage, photosPerPage,
